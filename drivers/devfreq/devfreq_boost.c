...
static struct df_boost_drv df_boost_drv_g __read_mostly = {
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_LLCCBW_DDR, CONFIG_DEVFREQ_MSM_LLCCBW_DDR_BOOST_FREQ),
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_CPU_LLCCBW, CONFIG_DEVFREQ_MSM_CPU_LLCCBW_BOOST_FREQ),
	BOOST_DEV_INIT(df_boost_drv_g, DEVFREQ_MSM_GPUBW, CONFIG_DEVFREQ_MSM_GPUBW_BOOST_FREQ)
};
